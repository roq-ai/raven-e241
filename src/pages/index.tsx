  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to RAVEN, your go-to solution for effortless inventory management of food products, ensuring efficiency, accuracy, and seamless operations."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1616401784845-180882ba9ba8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxpbnZlbnRvcnl8ZW58MHx8fHwxNjkyODgwODE5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to RAVEN, your go-to solution for effortless inventory management of food products, ensuring efficiency, accuracy, and seamless operations.`}
            </Text>
            <Box
