...
export function ProductListPage(props: ProductListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getProducts({
        relations: ['business', 'inventory.count', 'order.count', 'supply_chain.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('order', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('supply_chain', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'supply_chain',
          header: 'Supply Chain',
          accessorKey: 'supply_chain',
          cell: ({ row: { original: record } }: any) => record?._count?.supply_chain,
        }
      : null,
