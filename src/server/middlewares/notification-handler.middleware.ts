...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order.create': {
    roles: ['business-owner', 'inventory-manager', 'supply-chain-manager'],
    key: 'new-customer-order',
    tenantPath: ['business', 'user', 'order'],
    userPath: [],
  },
  'inventory.update': {
    roles: ['business-owner', 'supply-chain-manager'],
    key: 'inventory-update',
    tenantPath: ['business', 'product', 'inventory'],
    userPath: [],
  },
  'supply_chain.update': {
    roles: ['business-owner', 'inventory-manager'],
    key: 'supply-chain-update',
    tenantPath: ['business', 'product', 'supply_chain'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'inventory-manager', 'supply-chain-manager'];
